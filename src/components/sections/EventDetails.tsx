  ...
  return (
    <SectionWrapper withOrnament className="py-16 md:py-32 text-center bg-sage-50">
        ...
        <motion.div variants={fadeUpVariant} className="flex-1">
          <Card glass className="h-full flex flex-col hover:-translate-y-2 transition-transform duration-700 hover:shadow-2xl">
             <div className="mb-10 text-center">
               ...
               <p className="font-body text-teal-800/80 tracking-[0.2em] text-sm font-medium uppercase">{formatDate(weddingData.events.akad.date)}</p>
             </div>
             
             <div className="flex justify-center items-center gap-4 mb-8">
                <div className="h-[1px] w-full bg-teal-800/10" />
                <div className="w-2 h-2 rotate-45 bg-gold-400" />
                <div className="h-[1px] w-full bg-teal-800/10" />
             </div>

             <div className="space-y-8 mb-12 text-teal-900/80 text-center flex-1">
               <div className="flex flex-col items-center">
                 <span className="text-xs uppercase tracking-[0.2em] text-teal-800/50 mb-1 font-bold">Pukul</span>
                 <p className="text-xl font-heading italic">{weddingData.events.akad.time}</p>
               </div>
               <div className="flex flex-col items-center px-6">
                 <span className="text-xs uppercase tracking-[0.2em] text-teal-800/50 mb-2 font-bold">Lokasi</span>
                 <p className="text-lg font-heading text-teal-900 font-medium">{weddingData.events.akad.location}</p>
                 <p className="text-sm font-body text-teal-900/60 mt-2 text-balance leading-relaxed px-4">{weddingData.events.akad.address}</p>
               </div>
             </div>
        ...
        <motion.div variants={fadeUpVariant} className="flex-1">
          <Card glass className="h-full flex flex-col hover:-translate-y-2 transition-transform duration-700 hover:shadow-2xl">
             <div className="mb-10 text-center">
               ...
               <p className="font-body text-teal-800/80 tracking-[0.2em] text-sm font-medium uppercase">{formatDate(weddingData.events.resepsi.date)}</p>
             </div>
             ...
             <div className="space-y-8 mb-12 text-teal-900/80 text-center flex-1">
               ...
               <div className="flex flex-col items-center px-6">
                 <span className="text-xs uppercase tracking-[0.2em] text-teal-800/50 mb-2 font-bold">Lokasi</span>
                 <p className="text-lg font-heading text-teal-900 font-medium">{weddingData.events.resepsi.location}</p>
                 <p className="text-sm font-body text-teal-900/60 mt-2 text-balance leading-relaxed px-4">{weddingData.events.resepsi.address}</p>
               </div>
             </div>
      ...
      <motion.div variants={fadeUpVariant} className="relative z-10 mt-16 text-center">
        <p className="font-body text-sm text-teal-800/50 italic mb-4">Simpan tanggal di kalender Anda</p>
        <AddToCalendar />
      </motion.div>
    </SectionWrapper>
  );
