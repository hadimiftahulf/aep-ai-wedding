  ...
  return (
    <>
      ...
      >
        ...
        <div className="h-10 w-10 bg-teal-950 rounded-xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform text-xl">
           🎮
        </div>
        <div className="text-left flex-1">
          <p className="text-[8px] uppercase tracking-[0.3em] text-teal-950/40 font-black mb-0.5">Mini Game Break</p>
          <p className="text-[11px] font-bold text-teal-950 uppercase tracking-widest">Istirahat Sejenak?</p>
        </div>
