    ...
    return (
      <button
        ...
        className={cn(
          ...
          {
            "bg-teal-800 text-white hover:bg-teal-700 shadow-md hover:shadow-xl hover:-translate-y-1":
              variant === "primary",
            "bg-transparent border border-teal-800/20 text-teal-900 hover:border-gold-500 hover:text-gold-600":
              variant === "outline",
            "hover:bg-sage-100 text-teal-800/80 hover:text-teal-900": variant === "ghost",
            "h-10 px-6": size === "sm",
            "h-12 px-8": size === "md",
            "h-14 px-10": size === "lg",
          },
